                ...
                <div className={styles.container}>
                    ...
                    <div className={styles['card-list']}>
                        <div className={styles.card}>
                            <span><i className={`${styles.icon1} fa-solid fa-map-marked-alt`}></i></span>
                            <h5>Discover</h5>
